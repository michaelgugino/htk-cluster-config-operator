...
import (
	...
	"github.com/michaelgugino/htk-cluster-config-operator/pkg/controller/secrets"
...
func main() {
	...
	err = leader.Become(ctx, "htk-cluster-config-operator-secrets-lock")
	if err != nil {
		log.Error(err, "")
		os.Exit(1)
	}
	...
	if err := secrets.Add(mgr); err != nil {
		log.Error(err, "")
		os.Exit(1)
	}
